...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] firstNames = {"Ali","Babar","Bilal","Haider"};
        String[] lastNames = {"Muhammad","Shahzad","Qalandar","Rizvi"};

        MyArrayAdapter adap = new MyArrayAdapter(this,firstNames,lastNames);
